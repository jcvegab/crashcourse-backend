        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "level",
                    models.IntegerField(
                        choices=[(1, "Introductorio"), (2, "Intermedio"), (3, "Avanzado"), (4, "Completo")], default=1
                    ),
                ),
                ...
                (
                    "subcategory",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="core.subcategory"),
                ),
            ],
        ),
    ]
